...
import {Erc721SettleMock, Erc1155SettleMock} from "@coretest/shared/MockModules.sol";
...
/// @notice The three shapes {OwnershipInvariants} + a divisible SETTLE item
...
///
///  {OwnershipInvariants} is the core-shipped subject here, which is why this suite
///  stays in core; the settle modules it drives are local mocks, since core ships
///  none of its own.
contract ExoticSettlementTest is CoreSettlementBase {
    Erc721SettleMock nft721Module;
    Erc1155SettleMock nft1155Module;
    ...
    function setUp() public override {
        super.setUp();
        nft721Module = new Erc721SettleMock(address(settlement));
        nft1155Module = new Erc1155SettleMock(address(settlement));
