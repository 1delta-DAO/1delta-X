...
///   3. EulerV2OperatorModule (Borrow) borrows USDC from eUSDC-2 (via the EVC); proceeds
///      land at the solver.
...
contract EulerFlashLoanLeverageTest is EulerV2ModulesBase {
    function test_leverage_via_flashLoan_eulerV2() public {
        ...
        assertEq(IERC20(USDC).balanceOf(address(operatorModule)), 0, "taker module USDC drained");
    }
}
